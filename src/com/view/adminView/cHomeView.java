...
public class cHomeView extends cPanelContentApp{
    ...
    private cLabelInfo labelDataMenu = new cLabelInfo("Data Supplier", 0, 10, 240, 40);
    private cLabelInfo labelDataSeats = new cLabelInfo("Data Karyawan", 0, 10, 240, 40);
    private cLabelInfo labelDataTransaksi = new cLabelInfo("History Transaksi", 0, 10, 240, 40);
    private cLabelInfo labelDataHistory = new cLabelInfo("History Supplier", 0, 10, 240, 40);
    private cLabelInfo labelListTransaksi = new cLabelInfo("List Supplier", 30, 20, 580, 40);
