...
public class cUpdateSupplierView extends cPanelContentApp {
    ...
    public void setDataSupplier(int idSupplier, String typeSupplier, int supplierAmount, int priceTotal,
            String descriptionProduct) {
        this.idSupplier = idSupplier;

        txtTypeSupplier.setText(typeSupplier);
        txtSupplierAmount.setText(String.valueOf(supplierAmount));
        txtPriceSupplier.setText(String.valueOf(priceTotal));
        txtDescriptionSupplier.setText(descriptionProduct);
    }
    ...
    private void initsInputSupplierView() {
        ...
        btnSaveSupplier.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent ae) {
                handleUpdateSupplier(idSupplier);
            }
        });
    ...
    private void handleUpdateSupplier(int idSupplier) {
        ...
        boolean saveData = cUpdateDataSupplier.handleUpdateSupplier(idSupplier, typeSupplier, countSupplierText,
                priceSupplierText,
                descriptionSupplier);
        if (saveData) {
            txtTypeSupplier.setText(null);
