...
public class cInsertProductTransaksiView extends cPanelContentApp {
    ...
    public cInsertProductTransaksiView(cContentStaffView parentPanel, cInputTransaksiView inputTransaksiView) {
        super();
